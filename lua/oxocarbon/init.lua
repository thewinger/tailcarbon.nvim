...
vim.api.nvim_set_hl(0, "@lsp.mod.readonly", {link = "@lsp"})
...
vim.api.nvim_set_hl(0, "@punctuation.delimiter", {fg = oxocarbon.base04, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@punctuation.bracket", {fg = oxocarbon.base04, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@punctuation.special", {fg = oxocarbon.base04, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "@method", {fg = oxocarbon.base10, bg = oxocarbon.none})
